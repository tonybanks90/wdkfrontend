            ...
            <div style={{ display: 'flex', gap: 6, alignItems: 'center' }}>
              {wdk.evmAddress && (
                <div style={{ display: 'flex' }}>
                  <img src="/logos/ethereum-eth-logo.svg" alt="ETH" style={{ width: 16, height: 16, borderRadius: '50%', zIndex: 1, border: '1px solid rgba(0,0,0,0.2)' }} />
                  <img src="/logos/bnb-bnb-logo.svg" alt="BNB" style={{ width: 16, height: 16, borderRadius: '50%', marginLeft: -6, zIndex: 0, border: '1px solid rgba(0,0,0,0.2)' }} />
                </div>
              )}
              {wdk.solanaAddress && <img src="/logos/solana.svg" alt="SOL" style={{ width: 16, height: 16, borderRadius: '50%' }} />}
            </div>
            ...
            <>
              ...
              <div className="glass-card" style={{
                ...
                {wdk.evmAddress && (
                  <div style={{ marginBottom: 14 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 6 }}>
                      <div style={{ display: 'flex' }}>
                        <img src="/logos/ethereum-eth-logo.svg" alt="ETH Sepolia" style={{ width: 18, height: 18, borderRadius: '50%', zIndex: 1, border: '1px solid rgba(0,0,0,0.5)' }} />
                        <img src="/logos/bnb-bnb-logo.svg" alt="BNB Testnet" style={{ width: 18, height: 18, borderRadius: '50%', marginLeft: -8, zIndex: 0, border: '1px solid rgba(0,0,0,0.5)' }} />
                      </div>
                      <span style={{ fontSize: 13, fontWeight: 600, color: 'var(--color-text)' }}>Ethereum & BNB Chain</span>
                    </div>
                    <div style={{
                ...
                {wdk.solanaAddress && (
                  <div style={{ marginBottom: 14 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 6 }}>
                      <img src="/logos/solana.svg" alt="Solana Devnet" style={{ width: 16, height: 16, borderRadius: '50%' }} />
